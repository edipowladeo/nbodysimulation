!
!     MSIMSLMD.F90 - Declare double-precision MS IMSL MATH/LIBRARY routines
!
...
!
      ...
      interface
        complex *16function zasin (zinp)
          complex    *16 zinp
        end function
      end interface

      interface
        complex *16function zacos (z)
          complex    *16 z
        end function
      end interface

      interface
        complex *16function zatan (z)
          complex    *16 z
        end function
      end interface

      interface
        complex *16function zatan2 (csn, ccs)
          complex    *16 csn, ccs
        end function
      end interface

      interface
        complex *16function zsinh (z)
          complex    *16 z
        end function
      end interface

      interface
        complex *16function zcosh (z)
          complex    *16 z
        end function
      end interface

      interface
        complex *16function ztanh (z)
          complex    *16 z
        end function
      end interface
...
!
      ...
      interface
        complex *16function zwpl (z)
          complex    *16 z
        end function
      end interface

      interface
        complex *16function zwpld (z)
          complex    *16 z
        end function
      end interface

      interface
        complex *16function zwpq (z)
          complex    *16 z
        end function
      end interface

      interface
        complex *16function zwpqd (z)
          complex    *16 z
        end function
      end interface
