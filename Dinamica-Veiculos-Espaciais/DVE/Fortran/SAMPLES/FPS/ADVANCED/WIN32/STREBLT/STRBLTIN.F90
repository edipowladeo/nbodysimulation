...
integer*4 , parameter, public :: DID_SRCWIDTH   = 106
integer*4 , parameter, public :: DID_SRCHEIGHT  = 107

integer*4 , parameter, public :: DID_ROP0      = 110
integer*4 , parameter, public :: DID_ROP1      = 111
integer*4 , parameter, public :: DID_ROP2      = 112

integer*4 , parameter, public :: DID_NEWSRC    = 116
...
integer*4 , parameter, public :: WM_STRETCHBLT    = WM_USER+23
...
integer*4 , parameter, public :: NMODES      = 5

type (LookupEntry)  strebltModes(NMODES)
...
type (TrackObject) ptoSrc, ptoDest
integer*4 hdcSrc, hdcDest
integer*4 hbmSrc 
integer*4 hbmMask 

integer*4 , parameter, public :: NONE= -1

integer*4 iPatternBrush, glob_hittest, strebltMode
