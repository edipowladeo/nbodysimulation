...
!* INITIALIZE THE DIALOG BOX
  RET = DLGINIT(IDD_IMAGE, DLG)
  RET = DLGSETSUB(DLG, IDHELP_IMAGE, IMAGE_HELP)
  RET = DLGSETSUB(DLG, IDOK, IMAGE_OK)

!* GET THE CURRENT VALUES OF THE NUMBER OF POINTS AND PUT IT IN THE 
!* EDIT FIELD
  WRITE(CTEMP,*)IIMAGE
  RETLOG = DLGSET(DLG, IDC_EDIT_IMAGE, CTEMP)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE IMAGE_HELP(DLGPARENT, ID, CALLBACKTYPE)
  USE MSFLIB
  USE DIALOGM
...
!* INITIALIZE THE DIALOG BOX
  RET = DLGINIT(IDD_IMAGE_HELP, DLG2)

  IRET = DLGMODAL(DLG2)

  CALL DLGUNINIT(DLG2)
  RETURN
END SUBROUTINE IMAGE_HELP
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE IMAGE_OK(DLG, ID, CALLBACKTYPE)
  USE MSFLIB
  USE DIALOGM
  USE CHAOSCOM
...
!* GET THE NEW INFORMATION
  RET = DLGGET(DLG, IDC_EDIT_IMAGE, CTEMP)
  READ(CTEMP,*,IOSTAT = IERR)IIMAGE
  IF(IERR /= 0)THEN
!* ERROR CONDITION, PRINT MESSAGE, DESTRO BOX AND RECREATE
    ...
    WRITE(CTEMP,*)IIMAGE
    RET = DLGSET(DLG, IDC_EDIT_IMAGE, CTEMP)
    LERR = .TRUE.
  ENDIF
