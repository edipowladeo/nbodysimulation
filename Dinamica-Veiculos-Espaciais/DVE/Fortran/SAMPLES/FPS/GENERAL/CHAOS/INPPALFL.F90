SUBROUTINE INPPALLETFIL(CHECKED)
!***************************************************************************
!*																	       *
...
!***************************************************************************
  ...
  DLGTITLE = 'Input Palette Data File'C
  ...
  FRED%NFILTERINDEX = 2
  FRED%LPSTRFILE = LOC(PALLET_INP) 
  FRED%NMAXFILE = LEN(PALLET_INP) 
  ...
  PALLET_FILE_INP = .FALSE.
  IF(RET .AND. (IERROR == 0))THEN
	CALL READ_PALLET
	PALLET_FILE_INP = .TRUE.
  ENDIF

  RETURN
END SUBROUTINE INPPALLETFIL
