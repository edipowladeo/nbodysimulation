SUBROUTINE SAVPALLETFIL(CHECKED)
!***************************************************************************
!*																		   *
!*  THIS SUBROUTINE CREATES A DIALOG BOX THAT ALLOWS THE USER TO save THE  *
!*  PALLET DATA FILE.  THIS ROUTINE USES THE SYSTEM COMMON DIALOG ACCESSES *
...
!* DIALOG TITLE
  DLGTITLE = 'Save Palette Data File'C
...
!* SET UP STRUCTURE USED BY COMMON DIALOGS - SEE WIN32 API HELP FOR EXPLANATION
  ...
  FRED%NFILTERINDEX = 2
  FRED%LPSTRFILE = LOC(PALLET_SAV) 
  FRED%NMAXFILE = LEN(PALLET_SAV) 
