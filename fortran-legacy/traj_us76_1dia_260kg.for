...
!     Tempo de integração 
      ...
      TINTE    =    1.000000D+00        !Tempo de voo da nave. Em dias.
...
!     Característica da espaçonave 
      ...
      M4   =       260.000000D+00        !Em kg     Massa da nave
      Cd   =         2.200000D+00		   !Coeficiente de arrasto
	Ad   =		  38.400000D+00        !Área do satélite m2
...
!     Características da órbita
	...
	a4   =         6.811000000000000D+03       !Semieixo maior, em km	  
      e4   =         0.000000000000000D-00	   !Escentricidade
	i4   =        53.000000000000000D+00       !Inclinação r/ equador EVITE i4 = 180
	OM4  =	     100.000000000000000D+00       !Nodo ascendente graus2
	W4   =       200.000000000000000D+00       !Argumento do pericentro graus
	f4   =         0.000000000000000D+00       !Anomalia verdadeira graus  
...
!//////////////////////////////////////////////////////////////////////////////////////////
	...
	Double precision Xg,Yg,Zg,Vxg,Vyg,Vzg,V,TA,Cd,Ad,M4,Arx,Ary,Arz,
	+                 Ax,Ay,Az,X,Y,Z,Vx,Vy,Vz 
	Double precision R,h,Rem,UC,FV,FC,PI,TMo,P,de,A,B,C,D,E,Ac,Deg,WE,
	+                 OME
!-----------------------------------------------------------------------------------
      R   =     287.053D+00                          !J/kgK
	Rem =    6371.200D+00                          !km
