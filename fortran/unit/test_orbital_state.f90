module test_orbital_state
  implicit none
  private
  public :: run_test_orbital_state
contains
subroutine run_test_orbital_state(failures)
  ...
  if (failures == 0) print *, 'PASS: orbital state (circular, pericenter, polar, inclined invariants)'
contains
...
end subroutine run_test_orbital_state
end module test_orbital_state
